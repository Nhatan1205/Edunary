...
{
    public static string BuildRegistrationTemplate(string fullName, string verifyUrl, string siteUrl = "https://edunary.runasp.net/", string logoUrl = "https://res.cloudinary.com/dyuebf69z/image/upload/v1778492480/logo_brand_o2fonq_o1hqzz.png")
    {
        var encodedName = System.Net.WebUtility.HtmlEncode(fullName);
        var encodedVerifyUrl = System.Net.WebUtility.HtmlEncode(verifyUrl);
            ...
            <tr>
              <td align=""center"" style=""padding:32px 20px 0;"">
                <table role=""presentation"" width=""560"" cellpadding=""0"" cellspacing=""0"">
                  ...
                  <tr>
                    <td style=""padding-bottom:24px;"">
                      <h2 style=""margin:0 0 16px;font-size:20px;font-weight:700;color:#1c1d1f;"">Verify Your Email</h2>
                      ...
                      <p style=""margin:0 0 20px;font-size:15px;line-height:1.6;color:#1c1d1f;"">
                        Thank you for joining Edunary! Please click the button below to verify your email address and complete your account registration.
                      </p>
                      <table role=""presentation"" cellpadding=""0"" cellspacing=""0"">
                        <tr>
                          <td style=""border-radius:4px;background:#00A76F;"">
                            <a href=""{encodedVerifyUrl}"" style=""display:inline-block;padding:12px 24px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:4px;"">
                              Verify Email Address
                            </a>
                          </td>
                        </tr>
                      </table>
                      <p style=""margin:24px 0 8px;font-size:14px;color:#6a6f73;"">
                        If the button doesn't work, copy and paste this link into your browser:
                      </p>
                      <p style=""margin:0 0 16px;word-break:break-all;font-size:13px;color:#00A76F;"">
                        {encodedVerifyUrl}
                      </p>
                      <p style=""margin:0;font-size:13px;color:#6a6f73;"">
                  ...
                  <tr>
                    <td style=""padding-bottom:32px;"">
                      <p style=""margin:0;font-size:12px;color:#6a6f73;"">
                        You're receiving this email because you registered an account on Edunary.<br/>
    ...
    public static string BuildResetPasswordTemplate(string fullName, string resetUrl, string siteUrl = "https://edunary.runasp.net/", string logoUrl = "https://res.cloudinary.com/dyuebf69z/image/upload/v1778492480/logo_brand_o2fonq_o1hqzz.png")
    {
        var encodedName = System.Net.WebUtility.HtmlEncode(fullName);
            ...
            <tr>
              <td align=""center"" style=""padding:32px 20px 0;"">
                <table role=""presentation"" width=""560"" cellpadding=""0"" cellspacing=""0"">
                  ...
                  <tr>
                    <td style=""padding-bottom:24px;"">
                      <h2 style=""margin:0 0 16px;font-size:20px;font-weight:700;color:#1c1d1f;"">Reset Your Password</h2>
                      <p style=""margin:0 0 12px;font-size:15px;line-height:1.6;color:#1c1d1f;"">
                        Hello <strong>{encodedName}</strong>,
                      </p>
                      <p style=""margin:0 0 20px;font-size:15px;line-height:1.6;color:#1c1d1f;"">
                        We received a request to reset your Edunary account password. Click the button below to continue.
                      </p>
                      <table role=""presentation"" cellpadding=""0"" cellspacing=""0"">
                        <tr>
                          <td style=""border-radius:4px;background:#00A76F;"">
                            <a href=""{encodedResetUrl}"" style=""display:inline-block;padding:12px 24px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:4px;"">
                              Reset Password
                            </a>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td style=""padding-bottom:32px;"">
                      <p style=""margin:0;font-size:12px;color:#6a6f73;"">
                        You're receiving this email because you requested a password reset on Edunary.<br/>
                        &copy; {DateTime.UtcNow.Year} Edunary Inc.
                      </p>
                    </td>
                  </tr>
