...
namespace Edunary.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260607143855_AddLastPriceChangedAt")]
    partial class AddLastPriceChangedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.ConversationUserSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.CouponRedemption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.CourseApprovedSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CourseReviewSubmissionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseReviewSubmissionId");

                    b.ToTable("CourseApprovedSnapshots");
                });

            modelBuilder.Entity("Edunary.Domain.Entities.CourseCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InstructorNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.CourseReviewFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CourseReviewFeedbacks");
                });

            modelBuilder.Entity("Edunary.Domain.Entities.CourseReviewSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CourseReviewSubmissions");
                });
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.FinancialAccount", b =>
                {
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.FinancialEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountCode", "UserId");

                    b.ToTable("FinancialEntries");
                });

            modelBuilder.Entity("Edunary.Domain.Entities.FinancialTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.RevenueSharePlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("InstructorPercentage")
                        .HasPrecision(6, 4)
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.TaxProfile", b =>
                {
                    b.Property<string>("InstructorId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.TaxRegion", b =>
                {
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.UserAccountBalance", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "AccountCode", "Currency");

                    b.HasIndex("UserId");

                    b.ToTable("UserAccountBalances");
                });
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.Conversation", b =>
                {
                    b.HasOne("Edunary.Domain.Entities.Message", "LastMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.ConversationUserSetting", b =>
                {
                    b.HasOne("Edunary.Domain.Entities.Conversation", "Conversation")
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.CouponRedemption", b =>
                {
                    b.HasOne("Edunary.Domain.Entities.Coupon", "Coupon")
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.CourseApprovedSnapshot", b =>
                {
                    b.HasOne("Edunary.Domain.Entities.Course", "Course")
                        .WithMany("ApprovedSnapshots")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Edunary.Domain.Entities.CourseReviewSubmission", "Submission")
                        .WithMany()
                        .HasForeignKey("CourseReviewSubmissionId")
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.FinancialEntry", b =>
                {
                    b.HasOne("Edunary.Domain.Entities.FinancialAccount", "Account")
                        .WithMany()
                        .HasForeignKey("AccountCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Edunary.Domain.Entities.FinancialTransaction", "Transaction")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("Edunary.Domain.Entities.Course", b =>
                {
                    b.Navigation("ApprovedSnapshots");
