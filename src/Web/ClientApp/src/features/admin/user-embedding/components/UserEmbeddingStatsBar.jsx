...
function UserEmbeddingStatsBar({ syncData, isLoading }) {
  const totalUsers = syncData?.result?.totalUsers ?? 0;
  ...
  return (
    <Grid container spacing={2} sx={{ mb: 3 }}>
      <Grid item xs={12} sm={4}>
        <StatCard
          icon={<PeopleOutlineOutlinedIcon sx={{ color: "info.main", fontSize: 22 }} />}
          label="Users with Profiles"
          value={totalUsers}
          color="info"
          isLoading={isLoading}
        />
...
export default UserEmbeddingStatsBar;
